...
const { getUser, updateUser, removeUser, updateUserBalance, updateUserRole, updateUserPassword, getUserById, updateUserStatus } = require('../controllers/controller-user')
...
router.patch('/users/status', isAuth, isAdmin, updateUserStatus)
